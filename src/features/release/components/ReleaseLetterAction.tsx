...
export default function ReleaseLetterAction() {
  const { searchTerm, setSearchTerm, statusFilter, setStatusFilter ,setDate} =
        ...
        <div className="flex flex-col sm:flex-row gap-4 flex-1">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            />
             <input
      type="date"
      className="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-all focus:outline-none"
      name='createdAt'
        ...
        <div className="flex flex-wrap gap-3">
          <div className="flex gap-3">
            ...
            >
             ...
             <Link 
              to={'/dashboard/release-letter-upload'}
