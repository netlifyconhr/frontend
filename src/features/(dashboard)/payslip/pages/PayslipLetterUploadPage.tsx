...
const PayslipLetterUploadPage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    formData.append("multiplePayslipCsv", uploadedFile);
    let badRequesterror = false;

    axiosInstance
      .post("/payslip/upload-payslip-csv", formData, {
        headers: {
  ...
  const table = useReactTable({
    ...
    columns: PayslipUploadTableColumns,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200 mb-6">
          ...
          <p className="text-gray-600">
            Upload and process payslip letter information from Excel/CSV files
          </p>
        </div>
...
export default PayslipLetterUploadPage;
