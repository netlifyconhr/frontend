...
import ReleaseLetterAction from "./PayslipLetterAction";
import ReleaseLetterHeader from "./PayslipLetterHeader";
import ReleaseLetterListLoader from "./PayslipLetterListLoader";

const PayslipLetterRoot: React.FC<{ children: React.ReactNode }> = ({
  children,
}) => {
    ...
    <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      ...
      <div className="bg-white/80 overflow-hidden">
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
          <div className="md:text-sm text-gray-700 text-xs">
            Showing{" "}
...
export const PayslipLetter = Object.assign(PayslipLetterRoot, {
  Header,
  Body,
  Footer,
});
