...
import { ReleaseTableColumnsUpload } from "../components/ReleaseTableColumn";
...
const ReleaseLetterUploadPage: React.FC = () => {
  ...
  const poll = async (intervalId: NodeJS.Timeout) => {
    ...
    const url = `/release-letter?createdAt[$gte]=${encodeURIComponent(
      from
    ...
    try {
      ...
      if (Number(response?.data?.data?.length) >= parsedData?.length || error) {
        ...
        location.href = "/dashboard/relieving-letter";
      }
  ...
  const handleSubmit = async () => {
    ...
    formData.append("multipleReleaseLetterCsv", uploadedFile);
    let badRequesterror = false;

    axiosInstance
      .post("/release-letter/upload-release-letter-csv", formData, {
        headers: {
  ...
  const table = useReactTable({
    ...
    columns: ReleaseTableColumnsUpload,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-gray-200 mb-6">
          ...
          <p className="text-gray-600">
            Upload and process release letter information from Excel/CSV files
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-700">
                        payslip letter information data
                      </span>
                    </div>
                    <div className="flex items-center">
...
export default ReleaseLetterUploadPage;
